package com.cat.pages.web.aem.homePage.addToRequestModalPage;
...
public class AddToRequestModalPageAEM {
    ...
    private static final By START_DATE = By.xpath("//div[@class='modal-content']//td[@class='today in-range-min active start-date active end-date in-range available']");
    private static final By END_DATE = By.xpath("//div[@class='modal-content']//div[@class='drp-calendar right']//tbody//tr[5]//td[@data-title='r4c5']");
    ...
    public AddToRequestModalPageAEM clickOnQuantityPlus() {
