package com.cat.pages.mobile.homeScreen.requestServiceScreen;
...
public class RequestServiceScreen {
    ...
    public RequestServiceScreen verifyHeaderName() {
        //waitUntilElementToBeVisible(HEADER_NAME);
        areEqual(DriverManager.getDriver().findElement(HEADER_NAME).getText(),"Request Service");
        return this;
    }
